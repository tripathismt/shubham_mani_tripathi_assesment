...
function Suggestion(props) {
  return (
    <div className='relative xs:w-full'>
       <div className={`w-[22rem] ${props.login?"h-[30rem]":"h-[35rem]"} bg-[#F8F8F8] rounded-lg fixed right-7 bottom-[6rem] p-4 xs:w-full xs:bottom-0 xs:right-0`}>
          <div className='pl-4 pr-4 pb-6 text-xl font-semibold text-center'>
            Share your <span className='font-bold'>Suggestions</span>  with us for a chance to earn rewards!
          </div>
          ...
          <div className='flex flex-col'>
            ...
            <div>
                ...
                bg-[#CCCCCC] w-full
              font-medium rounded-lg text-m px-5 py-2.5 text-center inline-flex items-center justify-between " type="button">Select<svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
            ...
            <textarea id="message" rows="4" className=" block p-2.5 w-full h-[10.5rem] text-m text-gray-900 bg-[#CCCCCC]  border " placeholder="Write here..."></textarea>
            ...
            <button type="button" class="px-4 py-[0.15rem] text-s font-medium text-center text-white bg-[#0F0F0F] rounded-[4px] absolute  right-4 bottom-6" onClick={props.submitfun}>Submit</button>
